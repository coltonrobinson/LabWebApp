...
test('submit with shipping location calls batch interaction', () => {
    ...
    submit('S-1234')
    expect(mockAxios.get).toBeCalledWith('https://127.0.0.1:8000/api/create-location-log/', { "params": { "batch_id": 1, "location": "S-1234" } })
})
...
test('submit with testing location calls batch interaction', () => {
    ...
    submit('T-1234')
    expect(mockAxios.get).toBeCalledWith('https://127.0.0.1:8000/api/create-location-log/', { "params": { "batch_id": 1, "location": "T-1234" } })
})
