...
test('adding invalid sensor gets rejected', async () => {
    ...
    await inputSensor()
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/create-sensor/", { "params": { "batch_id": 3000, "check_digit": "ABCDE", "sensor_id": "12345" } })
})
...
test('submitting location starting with "R" creates location log and logs receving', async () => {
    ...
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/create-location-log/", { "params": { "batch_id": 3000, "location": "R-STD" } })
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/log-batch-interaction/", { "params": { "department": "receiving", "start": false, "technician_id": 1, "batch_id": 3000 } })
})
...
test('submitting location starting with "T" creates location log and logs testing', async () => {
    ...
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/create-location-log/", { "params": { "batch_id": 3000, "location": "T-STD" } })
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/log-batch-interaction/", { "params": { "department": "testing", "start": true, "technician_id": 1, "batch_id": 3000 } })
})
...
test('checkStatus called after 4 seconds', async () => {
    ...
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/get-online-sensors/", { "params": undefined })
})
...
test('removing batch creates popup and removes batch', async () => {
    ...
    expect(mockAxios.get).toBeCalledWith("https://127.0.0.1:8000/api/delete-batch/", { "params": { "batch_id": 3000 } })
})