...
test('clicking button navigates to ManageBatch screen', async () => {
    ...
    const batchButton = screen.getByText(/batch: 123/i)
    expect(mockAxios.get).not.toBeCalledWith("http://127.0.0.1/api/update-batch-technician/", { "params": { "batch_id": 123, "department": "testing", "technician_id": 1 } })
    await act(async () => {
        fireEvent.click(batchButton)
    })
    expect(mockAxios.get).toBeCalledWith("http://127.0.0.1/api/update-batch-technician/", { "params": { "batch_id": 123, "department": "testing", "technician_id": 1 } })
...
test('submit batch number with valid number navigates', async () => {
    ...
    expect(mockAxios.get).toBeCalledWith("http://127.0.0.1/api/get-batches-by-active-state/", {"params": {"active": true}})
    expect(mockAxios.get).toBeCalledWith("http://127.0.0.1/api/get-batch-by-id/", {"params": {"batch_id": 123}})
    expect(mockedUseNavigate).toBeCalledWith('/manageBatch')
})
...
test('submit batch number without technicianId doesn\'t continue', async () => {
    ...
    expect(mockAxios.get).not.toBeCalledWith("http://127.0.0.1/api/get-batch-by-id/", {"params": {"batch_id": 123}})
    expect(mockedUseNavigate).not.toBeCalledWith('/manageBatch')
})
...
test('submit batch number without proper batch number doesn\'t continue', async () => {
    ...
    expect(mockAxios.get).not.toBeCalledWith("http://127.0.0.1/api/get-batch-by-id/", expect.anything())
    expect(mockedUseNavigate).not.toBeCalledWith('/manageBatch')
})